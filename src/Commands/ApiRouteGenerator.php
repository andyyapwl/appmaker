...
class ApiRouteGenerator
{
    ...
    {
		$plural_name = str_plural($name);
        $line = "Route::resource('" . lcfirst($plural_name) . "', '" . $name . "Controller', ['except' => ['create', 'edit']]);";
    ...
    private function blockHasResource($name)
    {
        ...
        if (preg_match(preg_quote("/Route::resource('" . strtolower($name) . "', 'Api\\" . $name . "Controller'/"), $block)) {
            return true;
        }
        return false;
    }
